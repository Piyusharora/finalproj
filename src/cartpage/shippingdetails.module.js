  ...
  return (
   ...
   <div className="products">
    ...
    <Nav>
      ...
      <Nav.Link href="/shippingdetails" active style={{marginRight: '250px',borderBottom:"5px solid red"}}>2. Shipping Details</Nav.Link>
...
<hr/>
<input type="text" placeholder='First Name' class="mr-3"></input>
<input type="text" placeholder='Last Name'></input>
<br></br>

<input type="text" placeholder='Address' size="48"class="mb-3 mt-3 n"></input>
<br></br>
<input type="text" placeholder='Address2'size="48" class="mb-3"></input>
<br></br>
<select class="Country mr-3 mb-3"  placeholder="Country">
...
<br></br>
<input type="text" placeholder='Zip/Postal Code' class='mr-3 mb-3'></input>
...
<br/>
<small>24 hours for checkout</small>
</div>
<hr/>
